...
for (int i = 0; i < functions.size(); ++i) {
    if (functions.get(i).getText() == 'Propose without email') {
...
WebUI.click(findTestObject('MatchQ DEV/Candidate List page/Single Actions/Propose/Propose without email/button Change'))

WebUI.verifyElementText(findTestObject('MatchQ DEV/Candidate List page/Single Actions/Propose/Propose without email/notification Successfully proposed'), 
