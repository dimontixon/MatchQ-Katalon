...
WebUI.click(findTestObject('MatchQ DEV/Candidate List page/Single Actions/Action Hire'))

WebUI.click(findTestObject('MatchQ DEV/Candidate List page/Single Actions/Hire/button Change'))

WebUI.verifyElementText(findTestObject('MatchQ DEV/Candidate List page/Single Actions/Hire/notification Successfully hired'), 
    'The candidate has been succesfully hired!')
