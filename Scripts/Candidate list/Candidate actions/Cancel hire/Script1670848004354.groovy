...
WebUI.click(findTestObject('MatchQ DEV/Candidate List page/Filters/Filters Statuses/Status Hired'))
...
WebUI.click(findTestObject('MatchQ DEV/Candidate List page/Single Actions/Action Cancel hire'))

WebUI.click(findTestObject('MatchQ DEV/Candidate List page/Single Actions/Cancel hire/button Change'))

WebUI.verifyElementText(findTestObject('MatchQ DEV/Candidate List page/Single Actions/Cancel hire/notification Successfully cancel hire'), 
