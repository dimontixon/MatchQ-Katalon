...
WebUI.click(findTestObject('MatchQ DEV/Candidate List page/Single Actions/Action Reject'))

WebUI.click(findTestObject('MatchQ DEV/Candidate List page/Single Actions/Reject/button Change'))

WebUI.verifyElementText(findTestObject('MatchQ DEV/Candidate List page/Single Actions/Reject/notification Seccessfully rejected'), 
    'The candidate has been succesfully rejected.')
