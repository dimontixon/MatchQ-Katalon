...
WebUI.click(findTestObject('MatchQ DEV/Candidate List page/Single Actions/Remind/button Send reminder'))

WebUI.verifyElementText(findTestObject('MatchQ DEV/Candidate List page/Single Actions/Remind/notification Successfully reminded'), 
    'The reminder has been succesfully sent to the candidate!')
