...
List<WebElement> functions = WebUI.findWebElements(findTestObject('MatchQ DEV/Candidate List page/Filters/dropdown Item'), 10)

for (int i = 0; i < functions.size(); ++i) {
    if (functions.get(i).getText() == 'Propose with email') {
        WebUI.click(WebUI.convertWebElementToTestObject(functions.get(i)))
...
WebUI.click(findTestObject('MatchQ DEV/Candidate List page/Single Actions/Action Propose'))

WebUI.verifyElementClickable(findTestObject('MatchQ DEV/Candidate List page/Single Actions/Propose/Propose with email/button EN'))

WebUI.verifyElementClickable(findTestObject('MatchQ DEV/Candidate List page/Single Actions/Propose/Propose with email/button NL'))

WebUI.click(findTestObject('MatchQ DEV/Candidate List page/Single Actions/Propose/Propose with email/button Send message'))

WebUI.verifyElementText(findTestObject('MatchQ DEV/Candidate List page/Single Actions/Propose/Propose with email/notification Successfully proposed'), 
    'The proposition has been succesfully sent!')
